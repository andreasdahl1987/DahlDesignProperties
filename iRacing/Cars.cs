...
namespace User.PluginSdkDemo
{
    public class Cars
    {
        ...
        public Cars(
            ...
            double revLim,
            int idleRPM,
            double clutchBitePoint,
            double clutchSpin,
            double clutchIdealRangeStart,
            double clutchIdealRangeStop,
            double clutchGearRelease,
            double clutchTimeRelease,
            double clutchGearReleased,
            double clutchTimeReleased,
            bool highPower,
            double launchThrottle,
            double pitMaxSpeed,
            double pitCornerSpeed,
            double pitBrakeDistance,
            double pitAcceleration,
            double pitFuelFillRate,
            bool pitHasAnimatedCrew,
            double pitAniBaseTime,
            double pitAniSlowAdd,
            double pitBaseTime,
            double pitSlowAdd,
            CrewType crewType,
            bool pitMultitask,
